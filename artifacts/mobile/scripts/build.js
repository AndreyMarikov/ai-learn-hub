...
function getDeploymentDomain() {
  ...
  console.error(
    "ERROR: No deployment domain found. Set EXPO_PUBLIC_DOMAIN in your .env.local (e.g. EXPO_PUBLIC_DOMAIN=localhost)",
  );
  process.exit(1);
}
...
function getExpoPublicReplId() {
  return process.env.EXPO_PUBLIC_REPL_ID || null;
}
...
async function startMetro(expoPublicDomain, expoPublicReplId) {
  ...
  if (expoPublicReplId) {
    ...
    console.log("EXPO_PUBLIC_REPL_ID not set — skipping");
  }
